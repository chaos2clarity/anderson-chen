...
import { getRecentPosts, type MediumPost } from "@/lib/medium-posts";
...
export default function Projects() {
  ...
  // Load recent Medium posts
  const [recentPosts, setRecentPosts] = useState<MediumPost[]>([]);
                ...
                <div className="flex items-end justify-between mb-8">
                  <div>
                    ...
                    <p className="text-white/60 text-base md:text-lg font-light">
                      this blog section is automatically updated with my latest medium posts :D
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                ...
                >
                  {isLoading ? (
                    ...
                    <Link href={recentPosts[0].mediumUrl} target="_blank" rel="noopener noreferrer">
                      <article className="group relative overflow-hidden mb-6">
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            <div className={`w-2 h-8 ${
                              recentPosts[0].color === 'emerald' ? 'bg-emerald-400' :
                              recentPosts[0].color === 'blue' ? 'bg-blue-400' :
                              recentPosts[0].color === 'purple' ? 'bg-purple-400' :
                              recentPosts[0].color === 'orange' ? 'bg-orange-400' :
                              recentPosts[0].color === 'teal' ? 'bg-teal-400' :
                              'bg-blue-400'
                            }`}></div>
                    ...
                    <div className="text-center py-8">
                      <p className="text-white/60 mb-4">Blog posts are syncing from Medium...</p>
                      <div className="text-xs text-white/40">
                        Run <code className="bg-white/10 px-2 py-1 rounded">npm run sync-medium</code> to sync posts
                      </div>
                    </div>
                  )}
                </motion.div>
                ...
                <div className="lg:col-span-12 grid grid-cols-1 gap-6">
                  ...
                  {recentPosts && recentPosts.length > 1 && (
                    <motion.div 
                      ...
                      viewport={{ once: true }}
                    >
                      <Link href={recentPosts[1].mediumUrl} target="_blank" rel="noopener noreferrer">
                  ...
                  {recentPosts && recentPosts.length > 2 && (
                    <motion.div 
                      ...
                      viewport={{ once: true }}
                    >
                      <Link href={recentPosts[2].mediumUrl} target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900/50 via-slate-800/40 to-slate-900/20 border border-white/10 hover:border-white/20 transition-all duration-500 hover:shadow-2xl hover:shadow-slate-500/5">
                    ...
                    <div className="relative p-6">
                      ...
                      <p className="text-white/80 text-xs leading-relaxed mb-4">
                        ...
                        Built for scientific notations heavy content. <br/>
